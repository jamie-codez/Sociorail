...
import static com.voomantics.sociorail.Constants.FAILURE_RESULT;
...
public class FetchAddressIntentService extends IntentService {
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        if (intent != null) {
            ...
            if (addresses == null || addresses.isEmpty()) {
                ...
                deliverResultsToReceiver(SUCCESS_RESULT, TextUtils.join(
    ...
    private void deliverResultsToReceiver(int resultCode, String addressMessage) {
